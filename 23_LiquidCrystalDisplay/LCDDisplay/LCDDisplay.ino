...
//------------------------------------------------------------
// This sketch demonstrates truning the display on and off. Be
// aware that after turning the display on, any special config
// of the cursor, blink etc will need to be reset. Turning off
// the display clears those settings.
//------------------------------------------------------------
