...
// A0/ADC0 as its input pins and to trigger an interrupt when 
// the light level on an LDR is darker than a preset level set 
// by a small potentiometer. While the interrupt has not been
