...
This sketch uses the Analog Comparator in default mode where pin D6/AIN0 is the positive
input pin and D7/AIN1 is the negative input. Whenever the voltage measured on the positive 
