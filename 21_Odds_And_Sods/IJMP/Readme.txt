The IJMP sketch demonstrates the use of the IJMP instruction to make an indirect jump to the piece of code whose address is in the Z register, R31:R30. Beware that this sort of instruction can lead to spaghetti code as a further jump back into the loop will be required, unlike ICALL.
